...
const actions = {
  'load-clientes' (context) {
    let clientes
    Vue.http.get('//websports.herokuapp.com/api/clientes')
      .then(response => {
        let res = response
  ...
  'load-users' (context) {
    Vue.http.get('//websports.herokuapp.com/api/users')
      .then(response => {
  ...
  'load-reservas' (context) {
    Vue.http.get('//websports.herokuapp.com/api/reservas')
      .then(response => {
  ...
  'load-reserva' (context, id) {
    Vue.http.get(`//websports.herokuapp.com/api/reservas/${id}`)
      .then(response => {
  ...
  'update-user' (context, user) {
    ...
    Vue.http.put(`//websports.herokuapp.com/api/users/${user.id}`, data)
      .then(response => {
  ...
  'update-reserva' (context, reserva) {
    ...
    Vue.http.put(`//websports.herokuapp.com/api/reservas/${reserva.id}`, data)
      .then(response => {
        console.log(response.status)
      })
  },
  'update-clientes' (context, cliente) {
    ...
    console.log(data)
    Vue.http.put(`//websports.herokuapp.com/api/clientes/${cliente.id}`, data)
      .then(response => {
        console.log(response.status)
      })
  ...
  'create-users' (context, users) {
    Vue.http.post('//websports.herokuapp.com/api/users', users)
      .then(response => {
        console.log(response.status)
      })
  }
